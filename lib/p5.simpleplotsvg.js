...
(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    {
      var rc;
      var cm0 = colorMode()._colorMaxes[colorMode()._colorMode][0];
      var cm1 = colorMode()._colorMaxes[colorMode()._colorMode][1];
      var cm2 = colorMode()._colorMaxes[colorMode()._colorMode][2];
      var cm3 = colorMode()._colorMaxes[colorMode()._colorMode][3];
      if(Array.isArray(_c)){
        if(_c.length==1) rc = "rgb("+_c[0]+", " + _c[0] + ", " + _c[0] + ")";
        if(_c.length==2) rc = "rgba("+_c[0]+", " + _c[0] + ", " + _c[0] + ", " + _c[1]/255 + ")";
        if(_c.length==3&&colorMode()._colorMode=="rgb") rc = "rgb("+_c[0]+", " + _c[1] + ", " + _c[2] + ")";
        if(_c.length==4&&colorMode()._colorMode=="rgb") rc = "rgba("+_c[0]+", " + _c[1] + ", " + _c[2] + ", " + _c[3]/255 + ")";
        if(_c.length==3&&(colorMode()._colorMode=="hsb"||colorMode()._colorMode=="hsl")) rc = "hsl("+_c[0]+", " + _c[1] + "%, " + _c[2] + "%)";
        if(_c.length==4&&(colorMode()._colorMode=="hsb"||colorMode()._colorMode=="hsl")) rc = "hsla("+_c[0]+", " + _c[1] + "%, " + _c[2] + "%, " + _c[3]/255 + ")";
      }

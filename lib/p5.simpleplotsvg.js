  ...
  if (typeof define === 'function' && define.amd)
    ...
    get data() {
      ...
      */
      ...
      //this.svghtml = '<svg width="'+(this.right-this.left).toString()+'" height="'+(this.bottom-this.top).toString()+'">';
      /*
      this.left = 0;
      this.top = 0;
      this.pointdiameter = 5;
    ...
    display(){
		...
		//
		drawLineGraph(that) {
      that.svghtml = '<svg width="'+(that.right-that.left).toString()+'" height="'+(that.bottom-that.top).toString()+'">';
      push();
      ...
      pop();
      that.svghtml += '" style="fill:none;stroke:black;stroke-width:1"/></svg>';
      console.log(that.svghtml);
      that.plotdiv.html(that.svghtml);
		}

  ...
  if (typeof define === 'function' && define.amd)
    ...
    set fillcolor (fillcolor) {
      if(Array.isArray(fillcolor)){
        if(fillcolor.length==1) this._fillcolor = "rgb("+fillcolor[0]+", " + fillcolor[0] + ", " + fillcolor[0] + ")";
        if(fillcolor.length==2) this._fillcolor = "rgba("+fillcolor[0]+", " + fillcolor[0] + ", " + fillcolor[0] + ", " + fillcolor[1]/255 + ")";
        if(fillcolor.length==3&&colorMode()._colorMode=="rgb") this._fillcolor = "rgb("+fillcolor[0]+", " + fillcolor[1] + ", " + fillcolor[2] + ")";
        if(fillcolor.length==4&&colorMode()._colorMode=="rgb") this._fillcolor = "rgba("+fillcolor[0]+", " + fillcolor[1] + ", " + fillcolor[2] + ", " + fillcolor[3]/255 + ")";
        if(fillcolor.length==3&&(colorMode()._colorMode=="hsb"||colorMode()._colorMode=="hsl")) this._fillcolor = "hsl("+fillcolor[0]+", " + fillcolor[1] + "%, " + fillcolor[2] + "%)";
        if(fillcolor.length==4&&(colorMode()._colorMode=="hsb"||colorMode()._colorMode=="hsl")) this._fillcolor = "hsla("+fillcolor[0]+", " + fillcolor[1] + "%, " + fillcolor[2] + "%, " + fillcolor[3] + ")";
      }
      else if(Number.isInteger(fillcolor)) {
        this._fillcolor = "rgb("+fillcolor+", " + fillcolor + ", " + fillcolor + ")";
      }
      else {
    ...
    set strokecolor (strokecolor) {
      if(Array.isArray(strokecolor)) {
        if(strokecolor.length==1) this._strokecolor = "rgb("+strokecolor[0]+", " + strokecolor[0] + ", " + strokecolor[0] + ")";
        if(strokecolor.length==2) this._strokecolor = "rgba("+strokecolor[0]+", " + strokecolor[0] + ", " + strokecolor[0] + ", " + strokecolor[1]/255 + ")";
        if(strokecolor.length==3&&colorMode()._colorMode=="rgb") this._strokecolor = "rgb("+strokecolor[0]+", " + strokecolor[1] + ", " + strokecolor[2] + ")";
        if(strokecolor.length==4&&colorMode()._colorMode=="rgb") this._strokecolor = "rgba("+strokecolor[0]+", " + strokecolor[1] + ", " + strokecolor[2] + ", " + strokecolor[3]/255 + ")";
        if(strokecolor.length==3&&(colorMode()._colorMode=="hsb"||colorMode()._colorMode=="hsl")) this._strokecolor = "hsl("+strokecolor[0]+", " + strokecolor[1] + "%, " + strokecolor[2] + "%)";
        if(strokecolor.length==4&&(colorMode()._colorMode=="hsb"||colorMode()._colorMode=="hsl")) this._strokecolor = "hsla("+strokecolor[0]+", " + strokecolor[1] + "%, " + strokecolor[2] + "%, " + strokecolor[3] + ")";
      }
      else if(Number.isInteger(strokecolor)) {
        this._strokecolor = "rgb("+strokecolor+", " + strokecolor + ", " + strokecolor + ")";  
      }
      else {
    ...
    tokenize(_arr) {
      ...
      // let sc = that.colorfucker(that.strokecolor);
      // let fc = that.colorfucker(that.fillcolor);
    ...
    drawPointGraph(that) {
      ...
      for (let i=0; i<that._xkey.length; i++) {
        ...
        for(let j=0;j<that.plotData.length;j++)
        {
          ...
          that.svghtml += '<circle cx="' + x.toString() + '" cy="' + y.toString() + '" r="' + (that.pointdiameter*2*that.aa).toString() + '" stroke="'+sc+'" stroke-width="'+(that.strokeweight*that.aa).toString()+'" fill="'+that.fillcolor+'"/>';

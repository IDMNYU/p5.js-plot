...
(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    get gridcolor() {
      ...
      // start writing to svghtml + bgsvghtml
      this.svghtml = '<svg xmlns="http://www.w3.org/2000/svg" width="'+(this.width*this.aa).toString()+'" height="'+(this.height*this.aa).toString()+'">';
      this.bgsvghtml = '<svg xmlns="http://www.w3.org/2000/svg" width="'+(this.width*this.aa).toString()+'" height="'+(this.height*this.aa).toString()+'">';
    ...
    drawBG(that)
    {
      ...
      let i, xi, yi;
      for(i = 0;i<that.gridcols;i++) // cols
      {
        xi = map(i, 0, that.gridcols-1, x0, x1);
        this.bgsvghtml += '<line x1="'+xi+'" y1="'+y0+'" x2="'+xi+'" y2="'+y1+'" style="stroke:'+that.gridcolor+';stroke-width:'+(that.gridweight*that.aa).toString()+'" />';
      }
      for(i = 0;i<that.gridrows;i++) // rows
      {
        yi = map(i, 0, that.gridrows-1, y0, y1);

...
(function (root, factory) {
  if (typeof define === 'function' && define.amd)
	...
	p5.Plot = class {
      ...
      this.typelist.line = { // 1 contineous
                            // continueous function x y
        xtype: 'continuous',
        ytype: 'continuous',
        function: this.drawLineGraph
      };

      this.typelist.point = { // contineous x, contineous y
        xtype: 'continuous',
        ytype: 'continuous',
        function: this.drawPointGraph
      };

      this.typelist.area = { // 1 contineous
                            // continueous function x y
        xtype: 'continuous',
        ytype: 'continuous',
      ...
      this.typelist.density = { // 1 contineous
        xtype: 'continuous',
        ytype: 'none',
        function: this.drawDensityGraph
      };

      this.typelist.box = { // discrete x, contineous y
        xtype: 'discrete',
        ytype: 'continuous',
        function: this.drawBoxPlot
      };

      this.typelist.histogram = { // 1 contineous variable
        xtype: 'continuous',
        ytype: 'none',
        function: this.drawHistogram
      };

      this.typelist.bar = { // discrete x, contineous y
                            // discrete x
        xtype: 'discrete',
        ytype: 'continuous',
    ...
    drawBar(that){
      ...
      let barMargin = ((that.right-that.left)/numBars)/5;
      let drawWidth = (that.right-that.left)/numBars - barMargin*2; // width of each rect
